...
int dpofa(dd_real *a, integer *lda, integer *n, integer *
	info)
{
...
/*
    dpofa factors a dd_real precision symmetric positive definite 
    matrix. 
...
int dtrsl(dd_real *t, integer *ldt, integer *n, 
	dd_real *b, integer *job, integer *info)
{
    /* System generated locals */
...
/*     begin block permitting ...exits to 150 */
    ...
    for (*info = 1; *info <= i__1; ++(*info)) {
        /*     ......exit */
        if (t[*info + *info * t_dim1] == dd_real("0.0")) {
            goto L150;
        }
        /* L10: */
    }
