...
/* Subroutine */ int daxpyRef(integer *n, dd_real *da, dd_real *dx, 
	integer *incx, dd_real *dy, integer *incy)
{
...
/* Subroutine */ int dcopyRef(integer *n, dd_real *dx, integer *incx, 
        dd_real *dy, integer *incy)
{
...
dd_real ddotRef(integer *n, dd_real *dx, integer *incx, dd_real *dy, 
        integer *incy)
{
...
/* Subroutine */ int dscalRef(integer *n, dd_real *da, dd_real *dx, 
        integer *incx)
{
