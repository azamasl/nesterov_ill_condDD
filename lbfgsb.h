...
#define STOP_MAXITER 34 /*AZAM: message: STOP: TOTAL NO. of Iterations EXCEEDS MAXIT. */
...
#include <float.h>
//#ifndef DBL_EPSILON
#define EPSILON_DD 2.2e-32 //2.2e-16
//AZAMCOMMENT I think I have to force DBL_EPSILON to be 2.2e-32 bye using #ifdef...
//#endif
...
/* math.h */
//dd_real sqrt(dd_real);

extern dd_real ddot(integer *, dd_real *, integer *, dd_real *, 
        integer *);

extern  int daxpy(integer *, dd_real *, dd_real *, 
        integer *, dd_real *, integer *);

extern  int dscal(integer *, dd_real *, dd_real *, 
        integer *);

extern  int dcopy(integer *, dd_real *, integer *, 
	    dd_real *, integer *);

#define setulb FORTRAN_WRAPPER(setulb)
extern int setulb(integer *n, integer *m, dd_real *x, 
	dd_real *l, dd_real *u, integer *nbd, dd_real *f, dd_real 
	*g, dd_real *factr, dd_real *pgtol, dd_real *wa, integer *
	iwa, integer *task, integer *iprint, integer *csave, logical *lsave, 
	integer *isave, dd_real *dsave); /* ftnlen task_len, ftnlen csave_len); */

#define mainlb FORTRAN_WRAPPER(mainlb)
extern int mainlb(integer *n, integer *m, dd_real *x, 
        dd_real *l, dd_real *u, integer *nbd, dd_real *f, dd_real 
        *g, dd_real *factr, dd_real *pgtol, dd_real *ws, dd_real *
        wy, dd_real *sy, dd_real *ss, dd_real *wt, dd_real *wn, 
        dd_real *snd, dd_real *z__, dd_real *r__, dd_real *d__, 
        dd_real *t, dd_real *xp, dd_real *wa, integer *index, 
        integer *iwhere, integer *indx2, integer *task, integer *iprint, 
        integer *csave, logical *lsave, integer *isave, dd_real *dsave);
...
extern  int timer(dd_real *);
#define formk FORTRAN_WRAPPER(formk) 
extern int formk(integer *, 
        integer *, integer *, integer *, integer *, integer *, integer *, 
        logical *, dd_real *, dd_real *, integer *, dd_real *, 
        dd_real *, dd_real *, dd_real *, integer *, integer *, 
        integer *);
#define formt FORTRAN_WRAPPER(formt) 
extern  int formt(integer *, dd_real *, dd_real *, 
        dd_real *, integer *, dd_real *, integer *);
#define subsm FORTRAN_WRAPPER(subsm) 
extern int subsm(integer *, integer *, integer *, integer *, dd_real *, dd_real *, 
        integer *, dd_real *, dd_real *, dd_real *, dd_real *,
        dd_real *, dd_real *, dd_real *, dd_real *, integer *
        , integer *, integer *, dd_real *, dd_real *, integer *, 
        integer *);
#define prn1lb FORTRAN_WRAPPER(prn1lb) 
extern int prn1lb(integer *n, integer *m, dd_real *l, 
        dd_real *u, dd_real *x, integer *iprint, fileType itfile, dd_real *epsmch); 

#define prn2lb FORTRAN_WRAPPER(prn2lb) 
extern int prn2lb(integer *n, dd_real *x, dd_real *f, dd_real *g, 
        integer *iprint, fileType itfile, integer *iter, integer *nfgv, integer *nact, dd_real 
        * sbgnrm, integer *nseg, integer * word, integer * iword, integer * iback, dd_real * stp, 
        dd_real * xstep, ftnlen);

#define prn3lb FORTRAN_WRAPPER(prn3lb) 
extern int prn3lb(integer *n, dd_real *x, dd_real *f, integer *
...
extern int errclb(integer *n, integer *m, dd_real *factr, 
        dd_real *l, dd_real *u, integer *nbd, integer *task, integer *info,
        integer *k, ftnlen task_len);

#define active FORTRAN_WRAPPER(active) 
extern  int active(integer *, dd_real *, dd_real *,
        integer *, dd_real *, integer *, integer *, logical *, 
        logical *, logical *);
#define cauchy FORTRAN_WRAPPER(cauchy) 
extern int cauchy(integer *, dd_real *, 
        dd_real *, dd_real *, integer *, dd_real *, integer *, 
        integer *, dd_real *, dd_real *, dd_real *, integer *, 
        dd_real *, dd_real *, dd_real *, dd_real *, 
        dd_real *, integer *, integer *, dd_real *, dd_real *, 
        dd_real *, dd_real *, integer *, integer *, dd_real *, 
        integer *, dd_real *);
#define cmprlb FORTRAN_WRAPPER(cmprlb) 
extern  int cmprlb(integer *, integer *, dd_real *, 
        dd_real *, dd_real *, dd_real *, dd_real *, 
        dd_real *, dd_real *, dd_real *, dd_real *, integer *,
        dd_real *, integer *, integer *, integer *, logical *, 
        integer *);
#define matupd FORTRAN_WRAPPER(matupd) 
extern  int matupd(integer *, integer *, dd_real *, 
        dd_real *, dd_real *, dd_real *, dd_real *, 
        dd_real *, integer *, integer *, integer *, integer *, 
        dd_real *, dd_real *, dd_real *, dd_real *, 
        dd_real *);
#define lnsrlb FORTRAN_WRAPPER(lnsrlb) 
extern int lnsrlb(integer *n, dd_real *l, dd_real *u, 
...
extern  int projgr(integer *, dd_real *, dd_real *,
        integer *, dd_real *, dd_real *, dd_real *);

/* in linesearch.c */
#define dcsrch FORTRAN_WRAPPER(dcsrch) 
extern int dcsrch(dd_real *f, dd_real *g, dd_real *stp, 
...
extern  int dcstep(dd_real *, dd_real *,
        dd_real *, dd_real *, dd_real *, dd_real *,
        dd_real *, dd_real *, dd_real *, logical *, dd_real *,
        dd_real *);

#define dpofa FORTRAN_WRAPPER(dpofa)
extern int dpofa(dd_real *, integer *, integer *, 
		integer *);
#define dtrsl FORTRAN_WRAPPER(dtrsl)
extern int  dtrsl(dd_real *, integer *, integer *, 
		dd_real *, integer *, integer *);
