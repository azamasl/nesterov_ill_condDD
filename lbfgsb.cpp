...
/* ============================================================================= */
/* Subroutine */ int setulb(integer *n, integer *m, dd_real *x, 
...
/* -jlm-jn */
    ...
    ************ 
    ...
    factr is a dd_real precision variable. 
    ...
    pgtol is a dd_real precision variable. 
    ...
    wa is a dd_real precision working array of length 
    ...
    dsave is a dd_real precision working array of dimension 29. 
      On exit with 'task' = NEW_X, the following information is 
                                                            available: 
...
static dd_real c_b7 = dd_real("0.0");
...
/* Subroutine */ int mainlb(integer *n, integer *m, dd_real *x, 
	dd_real *l, dd_real *u, integer *nbd, dd_real *f, dd_real 
	*g, dd_real *factr, dd_real *pgtol, dd_real *ws, dd_real *
    ...
    integer *csave, logical *lsave, integer *isave, dd_real *dsave) /*(ftnlen ) */
/* 	task_len, ftnlen csave_len) */
{
    ...
    static dd_real gd, dr, rr, dtd;
    static integer col;
    static dd_real tol;
    static logical wrk;
    static dd_real stp, cpu1, cpu2;
    static integer head;
    static dd_real fold;
    static integer nact;
    static dd_real ddum;
...
/*
    ...
    ws, wy, sy, and wt are dd_real precision working arrays used to 
    ...
    wn is a dd_real precision working array of dimension 2m x 2m 
    ...
    snd is a dd_real precision working array of dimension 2m x 2m 
      used to store the lower triangular part of 
                N = [Y' ZZ'Y   L_a'+R_z'] 
                    [L_a +R_z  S'AA'S   ] 

    z(n),r(n),d(n),t(n), xp(n),wa(8*m) are dd_real precision working arrays. 
      z  is used at different times to store the Cauchy point and 
         the Newton point. 
      xp is used to safeguard the projected Newton direction 

    sg(m),sgo(m),yg(m),ygo(m) are dd_real precision working arrays. 
    ...
    if ( *task == START ) {
        ...
        *word = WORD_DEFAULT;
        ...
        if ( IS_STOP(*task) ) {
            ...
            //AZAM: This part is added by me in order to enforce maxit limit.
            //AZAM: STRSRT
            if ( *task == STOP_MAXITER ) {
                /*restore the previous iterate. */
                dcopy(n, &t[1], &c__1, &x[1], &c__1);
                dcopy(n, &r__[1], &c__1, &g[1], &c__1);
                *f = fold;
